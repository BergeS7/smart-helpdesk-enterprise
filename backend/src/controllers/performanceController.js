...
exports.technicianDashboard = async (req,res) => {
  try {
    ...
    res.json({...score,...details.rows[0],rating_distribution:distribution.rows,recent_ratings:ratings.rows});
  }
